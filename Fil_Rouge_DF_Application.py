...
photo_SMS_label = Label(fenetre, image = photo_SMS)
photo_SMS_label.place(x=20, y=10)

##Photo Telecom Paris
Telecom_img = Image.open("Telecom_paris_3.jpg")
photo_Telecom = ImageTk.PhotoImage(Telecom_img)
photo_Telecom_label = Label(fenetre, image = photo_Telecom)
photo_Telecom_label.place(x=1260, y=10)

##Label N 1
label_1 = Label(fenetre, text="Charger les données :", background="white", font = ("arial", 10, "bold"))
label_1.place(x=20, y=180)

##Label N 2
label_2 = Label(fenetre, text="", font = ("arial", 12))         #"Le fichier est chargé ... OK!
...
##Label N 3
label_3 = Label(fenetre, text="Les données :", background="white", font = ("arial", 10, "bold"))
label_3.place(x=20, y=300)

##Label N 3-1
label_3_1 = Label(fenetre, text="", justify = "left", font = ("arial",11))
label_3_1.place(x=20, y=330)

##Label N 4-0 : Titre de l'appli
label_4_0 = Label(fenetre, text="Projet Libre : Détection de Fraude « SMS Alert – 'Spam Detector' »", font = ("arial", 16, "bold"))
label_4_0.place(x=400, y=30)

##Label N 4 : Algos ML
label_4 = Label(fenetre, text="Choix de l'algorithme ML :", background="white", font = ("arial", 10, "bold"))
label_4.place(x=440, y=100)

##Label N 5 : Valeurs clés
label_5 = Label(fenetre, text="Valeurs clés :", background="white", font = ("arial", 10, "bold"))
label_5.place(x=440, y=300)

##Label N 6 : Accuracy (Précision, Robustesse)
label_6 = Label(fenetre, text="*Accuracy :", font = ("arial", 12))
f6 = font.Font(label_6, label_6.cget("font"))
f6.configure(underline=True)
label_6.configure(font=f6)
label_6.place(x=460, y=330)

label_6_1 = Label(fenetre, text="", font = ("arial", 12, "bold"))
label_6_1.place(x=550, y=330)

##Label N 7 : F1_Score (C'est la mesure de la précision du test)
label_7 = Label(fenetre, text="*F1_Score :", font = ("arial", 12))
f7 = font.Font(label_7, label_7.cget("font"))
f7.configure(underline=True)
label_7.configure(font=f7)
label_7.place(x=460, y=360)

label_7_1 = Label(fenetre, text="", font = ("arial", 12, "bold"))
label_7_1.place(x=550, y=360)

##Label N 13 : Temps d'éxecution (execution time)
label_13 = Label(fenetre, text="*Temps d'éxecution :", font = ("arial", 12))
...
label_10 = Label(fenetre, text="Visualisation (Heatmap):", background="white", font = ("arial", 10, "bold"))
...
label_11 = Label(fenetre, text="Détails (Explications):", background="white", font = ("arial", 10, "bold"))
label_11.place(x=900, y=470)    #910

label_11_1 = Label(fenetre, text="", justify = "left", font = ("arial", 10))
label_11_1.place(x=900, y=500)

##Label N 12 : Copyright
label_12 = Label(fenetre, text="© Groupe N°5 (ADE 2020): Eddy, Paul, Badr", font = ("arial", 10,"bold"))
...
bouton_browse = Button(fenetre, text="Browse", font = ("arial", 10, "bold"), command=browse)
bouton_browse.place(x=300, y=205)



##Radio Button (Algorithms)
radioValue = IntVar()       #value = StringVar()
bouton1 = Radiobutton(fenetre, text="Naïve Bayes Algorithm", variable=radioValue, value=1)      #1 er choix ==> Native Bayes:
bouton2 = Radiobutton(fenetre, text="Linear SVC Algorithm", variable=radioValue, value=2)        #2 eme choix ==> Linear SVC:
bouton3 = Radiobutton(fenetre, text="Random Forest Algorithm", variable=radioValue, value=3)     #3 eme choix ==> Random Forest:
...
bouton_lancer = Button(fenetre, text="Lancer", font = ("arial", 10, "bold"), command=lancer)
bouton_lancer.place(x = 700, y = 170)

#Creation du boutton Quitter
bouton_quitter = Button(fenetre, text="Quitter", font = ("arial", 10, "bold"), command=quit)
